...
$data = $connection->query("SELECT * FROM products ORDER BY id DESC"); 
?>
<!DOCTYPE html>
<html lang="en">
    <head>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = $data->fetch_assoc()) { ?>
                                            ...
                                            <td class="text-center"><img style="width: 100px; height: 100px;" src="<?= $row['thumbnail'] ?>" alt="<?= $row['name'] ?>"></td>
                                            ...
                                            <!-- <td class="text-center">
                                                ...
                                                <button data-id="<?= $row['id'] ?>" type="button" title="Xóa" class="btn btn-danger btn-delete">
